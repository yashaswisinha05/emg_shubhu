...
\begin{equation}
 \begin{aligned}
 \mathcal T=\{&\mathrm{pos},\mathrm{screen},\mathrm{future},\mathrm{cons},\\
...
motion intent, sEMG-to-future-IMU prediction, and correction regularization.
The corresponding coefficients were 1.00, 0.35, 0.50, 0.10, 0.05, 0.05,
and 0.01, in the order listed above.
